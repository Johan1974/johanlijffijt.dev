...
| Daisycon | Affiliate-netwerk, alternatief/aanvullend | ⏳ Publisher-account geverifieerd (privé, Basic-plan), wacht op goedkeuring media door Daisycon zelf | Geen actie — na goedkeuring kandidaat-merchant kiezen en aanvraag indienen |
...
- [ ] Daisycon: account geverifieerd, wacht op goedkeuring media door Daisycon (geen actie
      nodig). Daarna: kandidaat kiezen voor de "gespecialiseerde webshop"-affiliate-partner en
      merchant-aanvraag indienen.
